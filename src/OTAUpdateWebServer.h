#ifndef SGS_OTAUPDATEWEBSERVER_H
#define SGS_OTAUPDATEWEBSERVER_H
...
int doOTAUpdates(const char *host, const int port = 80) {
    ...
    otaWebServer.begin(port);
    Serial.println("OTA Update web service running.");
    return 0;
}
